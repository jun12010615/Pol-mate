        ...
        <div class="tab-content">
            ...
            <div class="tab-panel active" id="panelId">
                <div id="findIdForm">
                    ...
                    <a href="<%= request.getContextPath() %>/desktop/login.jsp" class="back-link">로그인 화면으로 돌아가기</a>
                </div>
                <div id="findIdDone" style="display:none;">
                    ...
                    <button class="btn-submit" onclick="location.href='<%= request.getContextPath() %>/desktop/login.jsp'">로그인 화면으로 이동</button>
                </div>
            </div>
...
async function doFindId() {
    ...
    try {
        var data = await fetch('<%= request.getContextPath() %>/findAccount', {
